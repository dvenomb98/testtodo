  ...
  const editTask = async (values: Task) => {
    try {
      ...
      await runTransaction(db, async (transaction) => {
        ...
        const newTasks = [...data.tasks.filter((t: Task) => t.id !== values.id), values];
              ...
              {sended ? (
                ...
                <>
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <Field name="status" className={`${inputStyles} cursor-pointer`} as="select">
