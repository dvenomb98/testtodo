              ...
              {sended ? (
                ...
                <>
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <a href="https://www.markdownguide.org/basic-syntax/" target="_blank" className="underline underline-offset-2 text-secondary-blue text-sm">Use markdown to style your description</a>
                  </div>
                  <div className="flex flex-col gap-1">
